    ...
    <section className="max-padd-container bg-hero bg-cover bg-no-repeat h-[722px] w-full">
      <div className="relative top-32 xs:top-48">
        ...
        <div className="inline-flex items-center justify-center gap-4 bg-white rounded ring-1 ring-slate-900/5 mt-4">
          <div className="text-center regular-14 loading-tight pl-5 cursor-default">
        ...
        <div className="flex flex-col  gap-4 mt-10 mb-4 max-w-64">
          ...
          <div className="h5 !font-semibold max-w-52">People succesfully got their dream homes.</div>
        </div>
        <div className="flex flex-col">
          ...
          <div className="bold-14 sm:bold-16 relative top-1">127k 
            <span className="regular-14 sm:regular-16"> Excellent Reviews</span></div>
        </div>
      </div>
    </section>
  );
