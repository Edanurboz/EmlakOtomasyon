...
const Footer = () => {
  return (
    <footer>
      ...
      {/* copyrights */}
      <p className='max-padd-container medium-14 py-2 px-8 rounded flexBetween mt-6 bg-gradient-to-r from-primary via-white to-white'><span>2025 abc</span><span>All rights reserved</span></p>
