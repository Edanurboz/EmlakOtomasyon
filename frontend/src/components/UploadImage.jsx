...
const UploadImage = ({prevStep, nextStep, propertyDetails, setPropertyDetails}) => {
    ...
    <div className='mt-12 flexCenter flex-col'>
        {!imageURL ? (
            ...
            <div onClick={() => widgetRef.current?.open()} className='w-3/4 h-[22rem] rounded-xl overflow-hidden cursor-pointer'>
                <img src={imageURL} alt="uploadedImg" className='h-full w-full object-cover' />
            </div>
        )}
